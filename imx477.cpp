...
int main(int argc, char **argv)
{
    ...
    // clibv4l2 *v4l2 = new clibv4l2("/dev/video1", WIDTH, HEIGHT, "RG12");
    // clibv4l2 *v4l2 = new clibv4l2("/dev/video0", WIDTH, HEIGHT, "GREY");
    clibv4l2 *v4l2 = new clibv4l2("/dev/video0", WIDTH, HEIGHT, "Y10 ");
    ...
    for (;;)
    {
        ...
        Mat frame(HEIGHT, WIDTH, CV_16UC1, (unsigned char *)start);

        // Mat img;
        // cvtColor(frame,img,COLOR_BayerBG2BGR);
